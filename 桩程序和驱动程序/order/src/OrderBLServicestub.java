...
public class OrderBLServicestub implements OrderBLService {
    ...
    public CustomerPO getCustomer(long id){
        return CustomerVO(customerName,customerPhone,creditNumber,customerBirthday,companyName);
    }//获得下单客户的信息

    public HotelPO getHotel(long id){
        return HotelVO(hotelName,hotelLocation,hotelPhone,stars);
    }//获得酒店信息

    public RoomPO getRoom(long id){
        return RoomVo(roomType,roomTotalNumber,roomAccessNumber,roomPrice);
    }//获得房间信息
